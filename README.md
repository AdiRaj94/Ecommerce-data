# Ecommerce-data
The project provides a comprehensive analysis of e-commerce performance across three key dimensions: Executive Insights, 
Revenue & Customer Satisfaction and Platform or geographic performance. The goal is to identify high-revenue drivers, 
monitor customer sentiment and optimize sales strategies across different digital platforms and regions.

Tools Used: Power BI desktop, DAX, Power query, Sql
Key Features:
